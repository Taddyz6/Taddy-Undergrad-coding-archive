...
public class AstroidFinal extends Game {
    ...
    // done: 2. rock broken into small rocks if it was a big rock,
       // else if it was a small one, the rock got destroyed.
    ...
    public AstroidFinal(int width, int height, Stage stage) {
        ...
        this.player = new ImageView("file:resources/spaceship.jpg");
        // some rectangle to represent the player
    ...
    protected void update() {
        ...
        isKeyPressed( KeyCode.LEFT, () -> player.setRotate(player.getRotate() + 2));
        //  moving spaceship conter-clockwise rotate
        isKeyPressed( KeyCode.RIGHT, () -> player.setRotate(player.getRotate() - 2));
        //  moving spaceship clockwise rotation
        isKeyPressed(KeyCode.SPACE, () -> shootBullet(player.getRotate()));
        // spaceship shoot bullet
        ...
        System.out.println("Current score: " + this.getScore() + " Available lives: " +
            this.getNumLives());
    ...
    /**
     * This is updateLives for short method length.
     */
    public void updateLives() {
        this.astroidMap.forEach((key, value) -> {
            if (Math.abs(player.getX() - value.getX()) < 20 &&
                Math.abs(player.getY() - value.getY()) < 20) {
                this.numLives--;
                if (this.numLives == 0) {
    ...
    /**
     * This is shoot bullet method.
     *
     * @param dir double dir
     */
    ...
    /**
     * This is set astroid map.
     *
     * @param astroidMap for hashmap
     */
